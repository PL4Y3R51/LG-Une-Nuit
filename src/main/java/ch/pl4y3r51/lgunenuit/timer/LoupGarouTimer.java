...
public class LoupGarouTimer extends BukkitRunnable {

    private final Game game;
    private int timer = 20;

    public LoupGarouTimer(Game game) {
        this.game = game;
    ...
    public void run() {
        if (timer == 0) {
            ...
            Bukkit.broadcastMessage("[§5One Night LG§r] Les loups-garous se rendorment");
