...
public class FrancMaconsTimer extends BukkitRunnable {

    private final Game game;
    private int timer = 10;

    public FrancMaconsTimer(Game game) {
        this.game = game;
    }
    ...
    public void run() {
        if (timer == 0) {
            ...
            Bukkit.broadcastMessage("[§5One Night LG§r] Les Francs-Maçons se rendorment");
